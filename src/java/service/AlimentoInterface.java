...
public interface AlimentoInterface {
    ...
    /**
     * Este metodo busca Alimentos por sus calorias, tiene que ser superior a la dada
    ...
    /**
     * Este metodo busca Alimentos por sus calorias, tiene que ser inferior a la dada
     * @param caloriasAlimento es un Float
     * @return Devuelve una lista de la entidad Alimento
     * @throws excepciones.ReadException se lanza cuando ocurre un error en la busqueda de los  objetos alimento
     * en la base de datos
    ...
    /**
     * Este metodo busca Alimentos por sus calorias, tiene que ser inferior e igual
     * y superior e igual a las dadas 
    ...
    /**
     * Este metodo busca Alimentos por sus Grasas , tiene que ser superior a la dada
    ...
    /**
     * Este metodo busca Alimentos por sus grasas, tiene que ser inferior a la dada
    ...
    /**
     * Este metodo busca Alimentos por sus grasas, tiene que ser inferior e igual
     * y superior e igual a las dadas 
    ...
    /**
     * Este metodo busca Alimentos por sus proteinas, tiene que ser superior a la dada
    ...
    /**
     * Este metodo busca Alimentos por sus proteinas, tiene que ser inferior a la dada
    ...
    /**
     * Este metodo busca Alimentos por sus proteinas, tiene que ser inferior e igual
     * y superior e igual a las dadas 
    ...
    /**
     * Este metodo busca Alimentos por sus carbohidratos, tiene que ser superior a la dada
    ...
    /**
     * Este metodo busca Alimentos por sus carbohidratos, tiene que ser inferior a la dada
     * @param carbohidratosAlimento es un Float
     * @return Devuelve una lista de la entidad Alimento
     * @throws excepciones.ReadException se lanza cuando ocurre un error en la busqueda de los  objetos alimento
     * en la base de datos
    ...
    /**
     * Este metodo busca Alimentos por sus carbohidratos, tiene que ser inferior e igual
     * y superior e igual a las dadas
